...
var httpsServer = require('https').createServer({
  key: fs.readFileSync(__dirname+'/ssl/5335129_www.lalila.top.key'),
  cert: fs.readFileSync(__dirname+'/ssl/5335129_www.lalila.top.pem')
},app);
httpsServer.listen(3000, function() {
  console.log("Server is listening on port 3000");
});
app.use('/', express.static(__dirname + '/client')); //指定静态HTML文件的位置.访问3000端口时会进入/client文件夹下的html文件
